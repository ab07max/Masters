...
public class ContactListActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProximitySensor = (TextView) findViewById(R.id.textBatteryLevel);
        //data = (TextView) findViewById(R.id.data);
        mSensorManager = (SensorManager) getSystemService(
                Context.SENSOR_SERVICE);
        mProximity = mSensorManager.getDefaultSensor(
...
//        textBatteryState.setText(mProximity+"%");
    ...
    SensorEventListener proximitySensorEventListener
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (event.sensor.getType() == Sensor.TYPE_PROXIMITY) {
                ProximitySensor.setText(String.valueOf(event.values[0]));
                TextView textBatteryState=(TextView)findViewById(R.id.textBatteryLevel);
                textBatteryState.setText(ProximitySensor.getText());
            }
        }
    };
