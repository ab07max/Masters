 ...
 */
 ...
 int main(void) {
  ...
  // to check for the total execution time of the algorithm
 ...
 /*************************************************************************/
   ...
   FILE * fp;
   if ((fp = fopen("/home/users/vbhamidipati1/project/web-dataset/web-Google/7500-50000-web-Google.txt", "r")) == NULL) {
 ...
 //********************************************************************************************* 
  ...
  /*************************************************************************/
   ...
   /*************************************************************************/
     ...
     printf("THE NUMBER OF VERTICES WERE %u\n", n_vertices);
     printf("THE NUMBER OF ITERATIONS WERE %u\n", n_iterations);
     printf("THE NUMBER OF EDGES WERE %u\n", n_edges);
     printf("Done\n");
